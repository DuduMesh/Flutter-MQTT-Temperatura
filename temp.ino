...
char ssid[] = "Projeto-Lader";        // your network SSID (name)
char pass[] = "Lader1234@";
...
#define DEV_NAME     "FIT_EDUARDO_PRESTES"
#define MQTT_USER    "mqtt_Use_Corradi"
#define MQTT_PW      "FIT_EDUARDO_PRESTES"
#define TOPIC_SUBSCRIBE "FIT_EDUARDO_PRESTES"   //Informe um Tópico único. Caso sejam usados tópicos em duplicidade, o último irá eliminar o anterior.
